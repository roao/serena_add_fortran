...
class SolidLanguageServer(ABC):
    ...
    def create(
        ...
        elif config.code_language == Language.FORTRAN:
            from solidlsp.language_servers.fortls_server import FortlsServer

            ls = FortlsServer(config, logger, repository_root_path, solidlsp_settings=solidlsp_settings)
